package com.gautam.authenticationservice.security.services;
...
import com.gautam.authenticationservice.security.models.Authorization;
import com.gautam.authenticationservice.security.models.CustomGrantedAuthority;
import com.gautam.authenticationservice.security.models.CustomUserDetails;
import com.gautam.authenticationservice.security.repositories.AuthorizationRepository;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public JpaOAuth2AuthorizationService(AuthorizationRepository authorizationRepository, RegisteredClientRepository registeredClientRepository) {
        ...
        this.jsonMapper = JsonMapper.builder().addModules(securityModules).build();
    }
